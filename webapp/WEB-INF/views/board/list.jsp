						...
						<tr>
							...
							<c:choose>
								<c:when test="${vo.depth > 0 }">
									<td class="left" style="padding-left:${20*vo.depth }px"><img
										...
										<a
										href="${pageContext.request.contextPath }/board/view?no=${vo.no }&p=${map.currentPage }&kwd=${map.keyword }">${vo.title }</a>
									</td>
								</c:when>
								<c:otherwise>
									<td class="left"><a
							...
							<td><c:choose>
									<c:when
										...
										<a
											href="${pageContext.request.contextPath }/board/delete?no=${vo.no }&p=${map.currentPage }&kwd=${map.keyword }"
											class="del">삭제</a>
									</c:when>
									<c:otherwise>
										&nbsp;
